...
/**************************************/
  ...
  static final public void declVar() throws ParseException {
    ...
    type();
    jj_consume_token(ident);
           dec.placerVariable(YakaTokenManager.identLu,tab.iterateur,dec.typeLu,tab);
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 40:
 ...
 */
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x100,0x50,0x100,0x0,0x200,0xc7,0xc7,0x85,0x3e400,0xc0000,0x300000,0x80850,0x850,0x50,0x3e400,0xc0000,0x300000,0x80000,};
   }
